		 ...
		 <div class="h-header">
		    <div class="container clearfix">
              ...
              <a class="navbar-brand  pt-md-0" href="/" target="_parent" aria-label="Etherscan">
                  <img id="logo-header" width="160"  src="../assets/img/logo-ether.png" alt="TDS Logo">                                                               
              </a>                       
            </div>
            <div class="navlist">
            	<ul>
		 ...
		 <div class="h-bg-dark">
          ...
          <div class="input-group input-group-shadow">
            ...
            <input id="txtSearchInput" type="text" 
            	...
            	autocomplete="off" 
            	spellcheck="false" 
            	placeholder="Search by Address / Txn Hash / Block" aria-describedby="button-header-search" name="q"  maxlength="68">
		 			  ...
		 			  <div class="col-lg-6 mb-4 mb-lg-0">
		 			  	  <div class="card">
			 			  	  ...
			 			  	  <div class="list-box block-list">
					 			  	 	<overlay-scrollbars class="block-tab" :options="{ scrollbars: { autoHide: 'scroll' } }" >
								        <!-- 内层盒子——内容区 -->
								   
								        	 <div class="row-col" v-for="(item,index) in blockList" :key="index">
								        	 	   ...
								        	 	   <div class="col-sm-4 w-media">
								        	 	   	  ...
								        	 	   	  <div class="pc-media">
									        	 	   	  ...
									        	 	   	  <div class="blockInfo">
									        	 	   	  	 ...
									        	 	   	  	 <p class="b-time text-secondary text-nowrap">{{item.time}}</p>
									        	 	   	  </div>
								        	 	   	  </div>
								        	 	   	  <!--手机端显示的样式-->
				        	 	           ...
				        	 	           <div class="col-sm-8 w-media">
								        	 	   	  <div class="blockInfo blockInfo-1">
								        	 	   	  	  ...
								        	 	   	  	  <div class=" b-txns">
								        	 	   	  	  	<!--事务数为0的时候显示下面的span-->
								        	 	   	  	  	<a class="b-color-active txns color-default" 
						      ...
						      <div class="card-footer">
						      	 <a class="btn btn-xs btn-block btn-soft-primary">View all blocks</a>
						      </div>
					      </div>
		 			  </div>
		 			  <div class="col-lg-6">
		 			  	...
		 			  	<div class="card">
			 			  	  ...
			 			  	  <div class="list-box block-list transactions-list">
					 			  	 	<overlay-scrollbars class="block-tab"  >
								        <!-- 内层盒子——内容区 -->
								   
								        	 <div class="row-col" v-for="(item,index) in transitionList" :key="index">
								        	 <div class="row block-row" >
								        	 	   <div class="col-sm-4 w-media">
								        	 	   	  ...
								        	 	   	  <div class="media-body">
								        	 	   	  	  ...
								        	 	   	  	  <a class="b-color-active t-hash line1" >{{item.hash}}</a>
								        	 	   	  	  <span class="b-time text-secondary text-nowrap">{{item.time}}</span>
								        	 	   	  </div>
				        	 	           ...
				        	 	           <div class="col-sm-8 w-media">
								        	 	   	  <div class="blockInfo blockInfo-1">
								        	 	   	  	  <div class=" b-address">
								        	 	   	  	  	...
								        	 	   	  	  	<span class="b-color-active b-height p-hash line1">{{item.From}}</span>
								        	 	   	  	  </div>
								        	 	   	  	  <div class=" b-txns">
								        	 	   	  	    <span class="color-default b-miner">To</span>
								        	 	   	  	  	 <span class="b-color-active b-height p-hash p-hash2 line1">{{item.To}}</span>
								        	 	   	  	  </div>
								        	 	   	  </div>
								        	 	   	  <div class="fr b-num text-secondary">
								        	 	   	  	<span class="s-amount" 
...
<script>
	...
	export default{
		data(){
			return{
				blockList:[
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'168',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'168',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'0',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'168',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'168',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'0',atime:'in 4 secs',amount:20},
				{height:'1365789',hash:'ffllelfjeokdksllkflflskldk',time:'2 mins ago',anum:'168',atime:'in 4 secs',amount:20},
				...
				transitionList:[
				 {hash:'0x42de1d9da24bd878fa80cd9b2233966ed31568eb24ae1946f04ff5945e4454ee',
